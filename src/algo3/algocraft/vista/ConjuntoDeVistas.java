...
public class ConjuntoDeVistas {
	...
	public ConjuntoDeVistas(Casilla casilla, PanelJuego panelJuego){
		...
		this.vistas.put(Refineria.class, new VistaRefineria(casilla,panelJuego));
		this.vistas.put(CentroDeMineral.class, new VistaCentroDeMineral(casilla,panelJuego));
